...
const Main = (props) => {
    ...
    function uploadImg(e) {
        if(file) upload(file, props.currentUser).then(() => {
    ...
    function getDataFrom(id = props.currentUser.uid) {
        getData(id).then(res => {
            ...
            setData((prev) => [...prev, ...wholeData].filter((value, index, array) => {
    ...
    return (
        <div className='main'>
            <Header/>
            {displayDetail ? <Detail setDisplayDetail={setDisplayDetail} setDetailPost={setDetailPost} currentUser={props.currentUser} addLike={addLike} detailPost={detailPost}/>
            : <Post setDetailPost={setDetailPost} setDisplayDetail={setDisplayDetail} getAllData={getAllData} addLike={addLike} data={data} setData={setData} currentUser={props.currentUser}/>}
